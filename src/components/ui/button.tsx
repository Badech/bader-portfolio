  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-heading font-semibold ring-offset-background transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        hero: "bg-primary text-primary-foreground hover:brightness-110 active:scale-[0.98] font-semibold",
        "hero-outline": "border-2 border-foreground/15 bg-background text-foreground hover:border-foreground/25 hover:bg-foreground/[0.03] active:scale-[0.98] font-semibold",
      },
      size: {
